                    ...
                    @forelse ($users as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <x-modal-del id="{{ $item->id }}" name="Tài khoản" route="admin.users.destroy"/>
                                @endif
                            </td>
                        </tr>
                    @empty
    ...
    <div class="modal fade text-left" id="createRole" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.register-users') }}" method="post">
                    @csrf
                    <div class="modal-body pb-0">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input id="input-pass" type="text" class="form-control bg-gray-light" name="password" placeholder="Nhập mật khẩu" readonly/>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="input-password" type="text" class="form-control bg-gray-light" name="password_confirmation" placeholder="Xác nhận mật khẩu" readonly/>
                        </div>
                    </div>
